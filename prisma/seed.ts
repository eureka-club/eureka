...
const regions: Record<string, unknown> = {
  ...
  'Middle East/North Africa': {
    ...
    iran: 'Iran',
    iraq: 'Iraq',
    'israel-palestinian-territories': 'Israel / Palestinian Territories ',
    jordan: 'Jordan',
    kuwait: 'Kuwait',
    lebanon: 'Lebanon',
    libya: 'Libya',
...
const countriesData = (r: string, taxonomyId: number, creatorId: number, parentId?: number) => {
...
async function main() {
  ...
  if (admin) {
    ...
    // console.log('regionTax', regionTax)
    if (!regionTax) {
  ...
  console.error('Not user admin found');
}
