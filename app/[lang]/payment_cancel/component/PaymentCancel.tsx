...
const PaymentCancel: FC<Props> = ({ session }) => {
                    ...
                    >
                        <Col className=' d-flex w-100 justify-content-center mt-5'>
                            <Box className=' d-flex flex-column'>
                                <Row className='p-3 '><h1 className='text-primary text-center  mb-5'><b>{t(dict,'cancelText')}</b></h1></Row>
                                <Row className='p-3 '><h1 className='text-primary text-center   mb-5'><b>{t(dict,'cancelExtraText')}</b></h1></Row>
