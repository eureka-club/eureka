...
const PaymentSuccess: FC<Props> = ({ session, cycleId }) => {
                    ...
                    >
                        <Col className=' d-flex w-100 justify-content-center mt-5'>
                            <Box className=' d-flex flex-column'>
                                <Row className='p-3 '><h1 className='text-primary text-center  mb-5'><b>{t(dict,'successText')}</b></h1></Row>
                                <Row className='p-3 '><h1 className='text-primary text-center   mb-5'><b>{t(dict,'successExtraText')}</b></h1></Row>
                                <Row className='w-100  p-2'>
                                    <Button className={`mt-4 btn btn-eureka  w-100`} onClick={() => router.push(`/cycle/${cycleId}`)}>
                                        {t(dict,'successButtomText')}
                                    </Button>
                                </Row>
                            </Box>
                        </Col>
