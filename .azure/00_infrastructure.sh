...
echo -e " ${COLOR_BLUE}DATABASE_URL=${COLOR_GREEN}'sqlserver://${databaseServerFqdn}:1433;database=${DATABASE_NAME};user=${DATABASE_SERVER_ADMIN_USER}@${DATABASE_SERVER_NAME};password=${DATABASE_SERVER_ADMIN_PASSWORD}'${NC}\n"
