...
import { findDetail, findWithoutLangRestrict, remove, updateFromServerFields } from '@/src/facades/work';
...
import { MISSING_FIELD, SERVER_ERROR, UNAUTHORIZED } from '@/src/response_codes';
...
export default getApiHandler()
  .delete<NextApiRequest, NextApiResponse>(async (req, res): Promise<any> => {
    ...
    try {
      let work = null;
      if (language) work = await findDetail(idNum, language);
