...
const HomeNotSingIn: FunctionComponent = ({  }) => {
  ...
  return  <>
            <div className='pt-2 mt-1 pt-lg-5 mt-lg-5'>
                ...
                <Grid container className='d-flex flex-column-reverse flex-lg-row justify-content-center'>
        ...
        <div className='d-flex flex-column  m-0'>
                 <Grid container className='d-flex flex-column flex-lg-row justify-content-center'>
                          <Grid className={`${styles.WorkSection} col-12 col-lg-6 p-5 d-flex flex-column justify-content-center aling-items-center`}>
                        ...
                        <Grid className={`p-3 p-lg-5 col-12 col-lg-6 border-top border-primary ${styles.WorkSectionImageContainer}`}>
                 ...
                 <Grid container className='d-flex flex-column-reverse flex-lg-row justify-content-center'>
                      <Grid className={`p-3 p-lg-4 col-12 col-lg-6`}>
                        <Container className='d-flex justify-content-center'>
                             <img  className={`ms-0 ${styles.CyclesSectionImage}`} src={`/join-cycle-${router.locale}.webp`} alt="" /> 
                          </Container>
                        </Grid>
                        <Grid className={`${styles.CyclesSection} col-12 col-lg-6 p-5 d-flex flex-column justify-content-center aling-items-center`}>
                ...
                <Grid container className='d-flex flex-column flex-lg-row '>
                        <Grid className={`${styles.EurekaSection} p-3 p-lg-4 col-12 col-lg-6 d-flex flex-column justify-content-center aling-items-center`}>
                        ...
                        <Grid className={`p-4 col-12 col-lg-6 border-bottom border-secondary`}>
                          <Container className='d-flex justify-content-center'>
         ...
         <div className='m-0 m-lg-5'>
          <Grid container className='mt-4 d-flex flex-column flex-lg-row '>
