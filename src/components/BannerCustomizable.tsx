        ...
        {show && (
          <>
            ...
            <Carousel indicators={true} controls={true}  style={{width: '90%'}} >
              <Carousel.Item className="text-secondary bg-gray-light" style={{ height: '18rem' }}>
                  <div className="d-flex flex-row" >
                    <div className='' >
                         <img
                          style={{width:'22em',height:'18em'}}
                          src={image1}
                          alt=""
                        />
                    </div>
                    <div className="d-flex flex-column px-5 py-3" style={{minWidth:'65%%'}}>
                      <h2 className="h1 fs-1">{bo?.SlideTitle1}</h2>
              ...
              <Carousel.Item className="text-secondary bg-gray-light" style={{ height: '65%' }}>
                <div className="d-flex flex-row" >
                    <div className='' >
                         <img
                          style={{width:'22em',height:'18em'}}
                    ...
                    <div className="d-flex flex-column  px-5 py-3" style={{minWidth:'65%'}}>
                      <h2 className="h1 fs-1">{bo?.SlideTitle2}</h2>
              ...
              <Carousel.Item className="text-secondary bg-gray-light" style={{ height: '18rem' }}>
                <div className="d-flex flex-row" >
                    ...
                    <div className="d-flex flex-column  px-5 py-3" style={{minWidth:'65%'}}>
                      <h2 className="h1 fs-1">{bo?.SlideTitle3}</h2>
