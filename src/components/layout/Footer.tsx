    ...
    <div className="container d-flex flex-column-reverse flex-lg-row justify-content-lg-between align-items-lg-center">
      <section className="mb-1 mb-lg-0">
        <div className="text-center d-flex flex-column flex-lg-row justify-content-around pt-3 text-secondary fs-6">
            <Link href="/manifest"><span className='text-secondary text-decoration-underline text-blue me-lg-5 mb-1 mb-lg-none' onClick={() => window.scrollTo(0, 0)}>{t(dict,'Manifest')} </span></Link>
            <Link href="/about"><span className='text-secondary text-decoration-underline me-lg-5 mb-1 mb-lg-none' onClick={() => window.scrollTo(0, 0)}>{t(dict,'About Eureka')}</span></Link>
            <Link href="/aboutUs"><span className='text-secondary text-decoration-underline me-lg-5 mb-1 mb-lg-none' onClick={() => window.scrollTo(0, 0)}>{t(dict,'About Us')}</span></Link>
            <Link href="/policy"><span className='text-secondary text-decoration-underline me-lg-5 mb-1 mb-lg-none' onClick={() => window.scrollTo(0, 0)}>{t(dict,'policyText')}</span></Link>
