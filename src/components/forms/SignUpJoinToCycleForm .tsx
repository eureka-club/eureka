...
const SignUpJoinToCycleForm: FunctionComponent<Props> = ({ noModal = false, session }) => {
  ...
  const handleSignUpGoogle = (ev: MouseEvent<HTMLButtonElement>) => {
    ...
    if (cycle?.access == 2) callbackUrl = `/transitionJoinPrivateCycle`;

    if (cycle?.access == 4) callbackUrl = `/transitionSignUpToPayCycle?cycleId=${router.query.cycleId}`;
  ...
  const handleJoinCycleClick = (ev: MouseEvent<HTMLButtonElement>) => {
    ...
    setLoading(true);
    execJoinCycle();
    if (session && cycle?.access == 1) router.push(`/cycle/${cycle.id}`);
    setLoading(false);
  };
          ...
          <Row className="d-flex justify-content-between">
            ...
            >
              <section className="mt-3">
                <Image src="/pelicula.webp" width={200} height={120} alt=""></Image>
              </section>
            </Box>
            <Box
...
,                <Row className=''>
              ...
              <Col className={`col-12 col-xl-6 mt-lg-4`}>
                <div className="p-3 d-flex flex-column justify-content-center align-items-center">
                  <Box
                    sx={{
                      width: ['100%', '60%', '40%', '90%', '100%'],
                      paddingTop: { sm: '5em' },
                      paddingLeft: { lg: '10em', xl: '21em' },
                    }}
                  >
                    <section className="">
                      <Row className="mb-2">
                        <span className="text-center " style={{ fontSize: '.8em', fontStyle: 'italic' }}>
                          {t('OrganinedBy')}
                        </span>
                      </Row>
                      <Row className="mb-2">
                      ...
                      <Row className="mb-4">
                        <span className="text-center " style={{ fontSize: '1em' }}>
                          {cycle.creator.name}
                        </span>
                      </Row>
                    </section>
                    <Row
                      className="mb-4 d-none d-md-flex justify-content-center align-items-center"
                      style={{ fontSize: '1.6em', fontStyle: 'italic' }}
                    >
                      <span className="text-center">
                        <b>{cycle.title.toUpperCase()}</b>
                      </span>
                    </Row>
                    <Row
                      className="mb-4 d-flex d-md-none justify-content-center align-items-center"
                    ...
                    <Row className="mb-4 d-none d-md-flex" style={{ fontSize: '1.4em', fontStyle: 'italic' }}>
                      <span className="text-center ">
                        {dayjs(cycle?.startDate).add(1, 'day').tz(dayjs.tz.guess()).format(DATE_FORMAT_LARGE)} -{' '}
                        {dayjs(cycle?.endDate).add(1, 'day').tz(dayjs.tz.guess()).format(DATE_FORMAT_LARGE)}
                      </span>
                    </Row>
              ...
              <Col className={`col-12 col-xl-6 my-xl-5`}>
                <Box
                  sx={{ ml: { xl: '6em' } }}
                  className="d-flex justify-content-center justify-content-xl-start align-items-center align-items-xl-start"
                >
              ...
              >
                {' '}
                <Image className="" src="/libro.webp" width={180} height={284} alt=""></Image>
              </Box>
            </Box>
          </Row>
              ...
              <Col className="col-12">
                ...
                >
                  <Box
                    className=""
                    sx={{
                      paddingX: { xs: '2em', sm: '7em', md: '12em', lg: '15em', xl: '25em' },
                      paddingY: { xs: '3em', sm: '6em' },
                    }}
                  >
                    <div className="">
                      <Box
                        ...
                        sx={{
                          width: '1',
                          paddingX: { lg: '2em' },
                          fontSize: { sx: '.6em', lg: '1.4em' },
                          display: 'flex',
                          justifyContent: 'center',
                        }}
                      >
                        {' '}
                        <span className="text-primary text-center mb-3  ">
                          <b>{t('WhyJoin')}</b>
                        </span>
                      </Box>
                      <div
          ...
          <Col className="col-12">
            <Row className="bg-primary d-flex justify-content-center align-items-center" style={{ height: '5rem' }}>
              <Box sx={{ fontSize: { sx: '.6em', lg: '1.4em' }, display: 'flex', justifyContent: 'center' }}>
                <p className="text-center text-white mt-2">
                  {t('ManifestoText1').toUpperCase()}
                  <br></br>
                  {t('ManifestoText2')}
                  <Link href="/manifest">
                    <a
          ...
          <Col className="col-12">
            ...
            >
              <Box
                ...
                sx={{ paddingX: { md: '8em', lg: '15em', xl: '25em' }, paddingY: '4em' }}
              >
                <Box
                  className=""
                  sx={{
                    width: '1',
                    paddingX: { xs: '2em', sm: '7em', lg: '2em' },
                    fontSize: { sx: '.6em', lg: '1.4em' },
                    display: 'flex',
                    justifyContent: 'center',
                  }}
                ...
                {(works && (
                  <CycleDetailWorks
                    size={'medium'}
                    cycleWorksDates={works as CycleWork[]}
                    showSocialInteraction={false}
                    showHeader={false}
                  />
                )) ||
              ...
              {cycle.access == 4 && price != -1 ? (
                <Box sx={{ fontSize: { sx: '.6em', lg: '1.4em' }, display: 'flex', justifyContent: 'center' }}>
                  <span className="text-center text-white">
                    {t('MembershipFee')} {`$${price} ${currency}`}
                  </span>{' '}
                </Box>
              ) : (
                <></>
          ...
          <Col className="col-12">
            ...
            >
              ...
              {cycle.access !== 4 ? (
                  ...
                  <Box className="py-4" sx={{ width: ['90%', '60%', '40%', '30%', '25%'] }}>
                    ...
                    {!session && (
                      <>
                        ...
                        >
                          ...
                          >
                            <img
                              className={`${styles.gmailLogo} me-1 me-lg-2`}
                          ...
                          <Form onSubmit={handleSubmitSignUp} className="mt-2">
                            ...
                            <Box>
                              ...
                              >
                                {t('HaveAccounttext')}
                                <span
                                  className={`d-flex cursor-pointer ms-1 me-1 ${styles.linkText}`}
                                  onClick={handleHaveAccountLink}
                                >
                                  {t('clic')}
                                </span>
                                {t('joinClub')}
                            ...
                            <Box>
                              {!loading && (
                                <Button type="submit" disabled={loading} className={`mb-4 btn btn-eureka  w-100`}>
                                  {t('I want to register now')}
                                </Button>
                              )}{' '}
                              {loading && <LinearProgress className="mb-4" />}
                            ...
                            >
                              ...
                              <Link href="/manifest" passHref>
                                <span className={` cursor-pointer ms-1 me-1 ${styles.linkText}`}>{t('termsText')}</span>
                              </Link>
                              {t('and')}
                        ...
                        {haveAccount && (
                          <Form onSubmit={handleSubmitSignIn} className="mt-2">
                            ...
                            <div className="d-flex justify-content-between mb-1">
                              <div></div>
                              <Button
                                onClick={handlerRecoveryLogin}
                                variant="link"
                                className={`btn-link d-flex link align-items-end cursor-pointer text-gray`}
                                style={{ fontSize: '.8em' }}
                              >
                                {t('forgotPassText')}
                              </Button>
                    ...
                    >
                      {' '}
                      <Image src="/mano2.webp" width={250} height={250} alt=""></Image>
                    </Box>
                  </Box>
