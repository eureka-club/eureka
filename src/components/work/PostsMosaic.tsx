...
const PostsMosaic: FunctionComponent<Props> = ({ work }) => {
  ...
  return (
    <>
      ...
      {work && work.posts != null && <Mosaic cacheKey={['WORK',work.id.toString()]}className='d-flex justify-content-center justify-content-md-start' stack={work.posts} parent={work} />}
    </>
  );
};
