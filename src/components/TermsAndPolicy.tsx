        ...
        <Grid container className="d-flex justify-content-between">
          <Grid className={`col-12`}>
            ...
            <div className={`${styles.contentText}`}>
              ...
              <p>
                {t('policyIntro2')} <a href="mailto:hola@eureka.club">hola@eureka.club</a>.
              </p>

              <p>
                {t('policyIntro3')} <a href="https://www.generateprivacypolicy.com/">{t('linkPolicyGenerator')}</a>.
              </p>

              <Trans
                i18nKey="termsAndPolicy:titles1To4"
                components={{ p: <p />, h2: <h2 />, ul: <ul />, li: <li /> }}
              />
              <h2>{t('title5')}</h2>
              ...
              <p>
                {t('title5P2')} <a href="https://www.generateprivacypolicy.com/#cookies">{t('LinkTitle5P2')}</a>.
              </p>
              ...
              <Trans i18nKey="termsAndPolicy:title8" components={{ p: <p />, h2: <h2 /> }} />
            </div>
          </Grid>
        </Grid>
      </Container>
