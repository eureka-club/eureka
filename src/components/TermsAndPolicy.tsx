...
const TermsAndPolicy: FunctionComponent<Props> = ({show}) => {
  ...
  return (
    ...
    <Row className='d-flex justify-content-between'>
          <Col className={`col-4 ${styles.menuSection}`}>
            <Container className={`${styles.imageContainer} d-flex flex-column align-items-center justify-content-center`}>
              ...
              <section className={`d-flex flex-column w-100 ${styles.menuSectionText}`}>
                    <p className={`mb-3 cursor-pointer ${styles.otherText} ${(show ==='policy') ? styles.otherTextSelected : '' }`} onClick={()=> router.push("/terms?show=policy")}>{t('policyText')}</p>
                    <p className={`cursor-pointer ${(show ==='manifesto') ? styles.otherTextSelected : '' } ${styles.otherText}`} onClick={()=> router.push("/terms?show=manifesto")}>{t('termsText')}</p>
              </section>
          </Col>
          <Col className={`col-12 col-lg-8`}>
          
          { (show === 'policy') && <div className={`${styles.contentText}`}> 
              <h3 className='mb-4'>{t('policyText')}</h3>
           ...
           { (show === 'manifesto') && <div className={`${styles.contentText}`}> 
              <h3 className='mb-4'>{t('termsText')}</h3>
              <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
