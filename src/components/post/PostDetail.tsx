      ...
      <Row className="mb-5 d-flex flex-column flex-md-row">
        <Col className='col-md-5 col-lg-4 col-xl-3'>
          ...
          <div className='mb-2 d-none d-md-block'>
            <MosaicItem cacheKey={cacheKey} className='' post={post} showdetail={false}/>
          </div>
          <div className='container d-sm-block d-md-none mb-2 mt-2 position-relative'>
             <MosaicItem cacheKey={cacheKey} className='postition-absolute start-50 translate-middle-x' post={post} showdetail={false}/>
          </div>
         </Col>
