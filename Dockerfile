...
ARG NEXT_PUBLIC_HYVOR_WEBSITE_ID
ENV NEXT_PUBLIC_HYVOR_WEBSITE_ID=$NEXT_PUBLIC_HYVOR_WEBSITE_ID
RUN echo "NEXT_PUBLIC_HYVOR_WEBSITE_ID => $NEXT_PUBLIC_HYVOR_WEBSITE_ID"

ARG NEXT_PUBLIC_HYVOR_SSO_KEY
ENV NEXT_PUBLIC_HYVOR_SSO_KEY=$NEXT_PUBLIC_HYVOR_SSO_KEY
RUN echo "NEXT_PUBLIC_HYVOR_SSO_KEY => $NEXT_PUBLIC_HYVOR_SSO_KEY"

ARG DAYS_FOR_FEED
ENV DAYS_FOR_FEED=$DAYS_FOR_FEED
RUN echo "DAYS_FOR_FEED => $DAYS_FOR_FEED"

ARG NEXT_PUBLIC_TAKE
ENV NEXT_PUBLIC_TAKE=$NEXT_PUBLIC_TAKE
RUN echo "NEXT_PUBLIC_TAKE => $NEXT_PUBLIC_TAKE"
