...
ARG GOOGLE_CLOUD_TRANSLATE_CREDENTIALS
ENV GOOGLE_CLOUD_TRANSLATE_CREDENTIALS=$GOOGLE_CLOUD_TRANSLATE_CREDENTIALS
RUN echo "GOOGLE_CLOUD_TRANSLATE_CREDENTIALS => $GOOGLE_CLOUD_TRANSLATE_CREDENTIALS"

ARG GOOGLE_CLOUD_PROJECT_ID
ENV GOOGLE_CLOUD_PROJECT_ID=$GOOGLE_CLOUD_PROJECT_ID
RUN echo "GOOGLE_CLOUD_PROJECT_ID => $GOOGLE_CLOUD_PROJECT_ID"
